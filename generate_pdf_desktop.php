...
$sql = "SELECT * FROM tbl_desktop WHERE d_id = ?";
...
<body>
    <div class="header">
        ...
        <div class="title-block">
            ...
            <p>Desktop Asset Details</p>
        </div>
    </div>

    <div class="content">
        <table>
            <tr><th>Basic Information</th><th>Information</th></tr>
            ...
            <tr><td>IPv4 Status</td><td>' . htmlspecialchars($data['ipv4_status']) . '</td></tr>47
            <tr><td>Physical Address [Wireless]</td><td>' . htmlspecialchars($data['physical_address_w']) . '</td></tr>
            <tr><td>Physical Address [Ethernet]</td><td>' . htmlspecialchars($data['physical_address_e']) . '</td></tr>
            ...
            <tr><td>Motherboard  / Baseboard </td><td>' . htmlspecialchars($data['motherboard']) . '</td></tr>
            ...
            <tr><td>Microsoft Office CD Key</td><td>' . htmlspecialchars($data['ms_office_cdk']) . '</td></tr>
            <tr><td>MS Office License Recovery</td><td>' . htmlspecialchars($data['ms_office_account_lr']) . '</td></tr>
            <tr><td>MS Office Passsword License Recovery</td><td>' . htmlspecialchars($data['ms_office_password']) . '</td></tr>
            <tr><td>MS License Backup Email</td><td>' . htmlspecialchars($data['backup_key']) . '</td></tr>
            <tr><td>MS License Backup(SPP Folder) </td><td>' . htmlspecialchars($data['spp_folder']) . '</td></tr>
                        <tr><td>Special Application with License</td><td>' . htmlspecialchars($data['special_application']) . '</td></tr>
            ...
            <tr><td>Barcode Scanner Model</td><td>' . htmlspecialchars($data['scanner_model']) . '</td></tr>
...
$dompdf->render();
$dompdf->stream("inventory_item_" . $data['d_id'] . ".pdf", ["Attachment" => false]);
