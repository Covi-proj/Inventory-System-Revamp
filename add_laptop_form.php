...
<body>
    ...
    <div class="form-container">
        ...
        <form id="addForm" action="add_laptop.php" method="POST">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" id="computer_name" name="computer_name" placeholder="Enter Computer Name">
                </div>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="laptop_model">Client</label>
                    <input type="text" id="client" name="client" placeholder="Enter Client">
                </div>

                <div class="form-group">
                    <label for="physical_address_w">Section</label>
                    <input type="text" id="section" name="section" placeholder="Enter section">
                </div>

                <div class="form-group">
                    <label for="laptop_model">Brand and Model</label>
                    <input type="text" id="laptop_model" name="laptop_model" placeholder="Enter Brand and Model">
                </div>

                 <div class="form-group">
                    <label for="laptop_model">Type of Device</label>
                    <input type="text" id="d_type" name="d_type" placeholder="Enter Type of Device">
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="mac_address" name="mac_address" placeholder="Enter Wireless Address">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ipv4_status" name="physical_address" placeholder="Enter IPV4 Status">
                </div>
            ...
            <div class="row">
                 <div class="form-group">
                    ...
                    <input type="text" id="os_license" name="os_license" placeholder="Enter OS License">
                </div>


                <div class="form-group">
                    <label for="ms_os_p">MS OS Product ID</label>
                    <input type="text" id="ms_os_product_id" name="ms_os_product_id" placeholder="Enter MS OS Product ID">
                </div>

                <div class="form-group">
                    <label for="os_pk">Operating System Product Key</label>
                    <input type="text" id="os_pk" name="os_pk" placeholder="Enter OS Product Key">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="spp_folder" name="spp_folder" placeholder="Enter IPV4 Status">
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="special_app" name="special_app" placeholder="Enter Special Application">
                </div>
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="warranty_card" name="warranty_card" placeholder="Enter Remarks">
                </div>

                <div class="form-group">
                    <label for="warranty_card">Noah</label>
                    <input type="text" id="noah" name="noah" placeholder="Enter Remarks">
                </div>

                <div class="form-group">
                    <label for="warranty_card">Printer Model</label>
                    <input type="text" id="printel_model" name="printer_model" placeholder="Enter Printer Model">
                </div>

                <div class="form-group">
                    <label for="warranty_card">Barcode Scanner</label>
                    <input type="text" id="barcode_scanner" name="barcode_scanner" placeholder="Enter Barcode Scanner">
                </div>
